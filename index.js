...
app.get('/characters/new', requireAuth, (req, res) => {
  ...
  const character = {
    ...
    skills: [
      ...
      { name: 'Aether', ability: 'intelligence', proficient: false },
      { name: 'Anarchionomy', ability: 'wisdom', proficient: false },
      ...
      { name: 'Biothaumaturgy', ability: 'intelligence', proficient: false },
      { name: 'Cerebrumancy', ability: 'intelligence', proficient: false },
      { name: 'Deception', ability: 'charisma', proficient: false },
      { name: 'Fabrimancy', ability: 'charisma', proficient: false },
      ...
      { name: 'Luxomancy', ability: 'intelligence', proficient: false },
      { name: 'Medicine', ability: 'wisdom', proficient: false },
      { name: 'Nature', ability: 'intelligence', proficient: false },
      { name: 'Nexumancy', ability: 'intelligence', proficient: false },
      { name: 'Null', ability: 'intelligence', proficient: false },
      ...
      { name: 'Spectromancy', ability: 'intelligence', proficient: false },
      { name: 'Stealth', ability: 'dexterity', proficient: false },
      { name: 'Sortisism', ability: 'dexterity', proficient: false },
      { name: 'Survival', ability: 'wisdom', proficient: false },
      { name: 'Thanaturgy', ability: 'intelligence', proficient: false },
      { name: 'Transiturgy', ability: 'intelligence', proficient: false }
    ],
    customSkills: [],
    equipment: '',
    features: '',
